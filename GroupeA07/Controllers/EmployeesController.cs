...
namespace GroupeA07.Controllers
{
    ...
    public class EmployeesController : ApiController
    {
       ...
       // private string cnS = "Server=tcp:groupea07.database.windows.net,1433;Initial Catalog=groupea07;Persist Security Info=False;User ID=helha;Password=Groupea07;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
